...
/**
 * Provider-agnostic response DTO for customer data pull operations.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CustomerDataProviderResponse implements Serializable {
    ...
    private Map<String, Boolean> verificationResults;
