...
public class KfsRbiCompliantMappingServiceImpl implements KfsRbiCompliantMappingService {
    ...
    private Map<String, Object> extractQualitativeInformation(Loan loan, KfsDocumentData documentData) {
        ...
        // Table structure fields for proper rendering
        ...
        // Combined values for table cells (following the pattern from image 1)
        qualitative.put("COLLABORATIVE_LENDING_ORIGINATING_RE_COMBINED",
                collaborativeLendingInfo.get("originatingReName") + "\n" + collaborativeLendingInfo.get("originatingReFunding"));
        qualitative.put("COLLABORATIVE_LENDING_PARTNER_RE_COMBINED",
                collaborativeLendingInfo.get("partnerReName") + "\n" + collaborativeLendingInfo.get("partnerReFunding"));
        qualitative.put("COLLABORATIVE_LENDING_BLENDED_RATE_COMBINED", collaborativeLendingInfo.get("blendedRate"));
