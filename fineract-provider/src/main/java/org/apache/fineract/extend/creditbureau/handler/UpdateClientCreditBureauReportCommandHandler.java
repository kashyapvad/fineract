...
/**
 * Command handler for updating credit bureau reports.
 *
 * This handler processes commands to update existing credit bureau reports with new information or corrections.
 */
@Service
@RequiredArgsConstructor
@CommandType(entity = "CLIENT_CREDIT_REPORT", action = "UPDATE")
public class UpdateClientCreditBureauReportCommandHandler implements NewCommandSourceHandler {
